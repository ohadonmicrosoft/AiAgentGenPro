...
export const DragProvider: React.FC<{ children: React.ReactNode }> = memo(({ 
  ...
  const updateDrag = useCallback(
    ...
    [dragState.isDragging, dragState.draggedItem, dragState.currentPosition, dragState.targetContainerId],
  );
      ...
      try {
        ...
        if (result.isDropped) {
          if (result.isReordered) {
            dragAnnouncement.textContent = 'Item reordered within the same container';
          } else {
