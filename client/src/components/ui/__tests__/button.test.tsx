...
describe('Button', () => {
  ...
  it('renders with different variants', () => {
    ...
    expect(screen.getByRole('button', { name: /destructive/i })).toHaveClass('text-destructive');
    ...
    expect(screen.getByRole('button', { name: /ghost/i })).toHaveClass('hover:bg-accent/50');
  ...
  it('renders with different sizes', () => {
    ...
    expect(screen.getByRole('button', { name: /extra small/i })).toHaveClass('h-7');
    
    rerender(<Button size="xl">Extra Large</Button>);
    expect(screen.getByRole('button', { name: /extra large/i })).toHaveClass('h-12');
  });
  ...
  it('gracefully handles errors in click handler', async () => {
    ...
    const { user } = render(<Button onClick={brokenHandler}>Error Button</Button>);
