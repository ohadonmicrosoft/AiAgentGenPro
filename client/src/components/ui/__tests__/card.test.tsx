...
describe('Card Component', () => {
  ...
  it('applies classNames correctly', () => {
    render(
      <Card className="test-class">
        <CardHeader className="header-test-class">
          ...
          <CardDescription className="desc-test-class">Description</CardDescription>
        </CardHeader>
    ...
    expect(screen.getByTestId('card-description')).toHaveClass('desc-test-class');
    expect(screen.getByTestId('card-content')).toHaveClass('content-test-class');
