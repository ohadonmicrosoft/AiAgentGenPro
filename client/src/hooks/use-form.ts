    ...
    async (data) => {
      ...
      try {
        ...
        if (toastConfig?.success) {
          const successToast = typeof toastConfig.success === "object"
            ? toastConfig.success
            : { title: "Success", description: "Form submitted successfully" };
        ...
        if (toastConfig?.error) {
          const errorToast = typeof toastConfig.error === "object"
            ? toastConfig.error
            : { title: "Error", description: error instanceof Error ? error.message : "Form submission failed" };
